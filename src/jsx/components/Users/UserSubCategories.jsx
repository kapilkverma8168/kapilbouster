...
// import { getAllSubCategory } from '../../../services/adminApiService/UserLevel';
...
//                                                     <>
//                                                         <td>{content.id}</td>
//                                                         <td>{content.sub_category_name}</td>


//                                                         <td><Link to={"#"}>{content.category_name_view}</Link></td>
//                                                         <td>
...
// export default UserSubCategories